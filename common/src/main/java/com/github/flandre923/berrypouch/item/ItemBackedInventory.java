...
//
//        if(stack.getItem() instanceof  BerryPouch berryPouch1){
//            pouchSize = berryPouch.getSize();
//        }
////        if (pouchSize == BerryPouchType.SMALL.getSize()) {
////            this.pouchStorageSlot = BerryPouch.POUCH_GUI_24_STORAGE_SLOT;
////        } else if (pouchSize == BerryPouchType.MEDIUM.getSize()) {
////            this.pouchStorageSlot = BerryPouch.POUCH_GUI_30_STORAGE_SLOT;
////        } else if (pouchSize == BerryPouchType.LARGE.getSize()) {
